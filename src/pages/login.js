      ...
      <div className={`${style.body} bg-success`}>
        <div className={`${style.background} `}>
          <div className="border rounded-3 p-3 col-8 mx-auto bg-light">
            <h1 className="text-center border-bottom text-success p-3">Login</h1>
            <form>
              ...
              <div className="mb-1 p-3">
                  <button type='button' onClick={LoginUser} className="btn-success form-control btn text-light">
                  Login
                  </button>
              </div>
